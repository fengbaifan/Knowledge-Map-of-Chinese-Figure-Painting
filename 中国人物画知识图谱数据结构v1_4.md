...
为确保学术数据的可追溯性和可靠性，所有实体表均包含以下来源追踪字段：

| 字段名称 | 数据类型 | 描述 | 必填性 |
| :---- | :---- | :---- | :---- |
| source\_book | String | 来源典籍名称 | 必填 |
| source\_chapter | String | 来源章节/卷次 | 可选 |
| source\_text | Text | 原始引用文本 | 可选 |

**说明**：
- **source_book**：记录信息来源的原始文献，如《历代名画记》、《宣和画谱》等
- **source_chapter**：记录具体章节信息，如"卷一 顾野王"、"卷三 西京寺观等画壁"
- **source_text**：保留完整的原始文本，便于学术验证和引用
